...
var GameScene = (function (_super) {
    ...
    function GameScene() {
        _super.call(this);
        // 需要用到的数据
        this.floatFloorSpeedX = 6; // 浮动台阶左右移动的最大速度
        this.gravity = -10; // 重力，物体下落速度
        this.jumpSpeedY = 6; // 英雄的跳跃y速度
        this.jumpSpeedX = 4; // 英雄的跳跃x速度
        this.floatFloor = []; // 浮动的台阶刚体集合
        this.posArray = []; // 坐标集合
        this.init();
    }
    ...
    p.createUI = function () {
        ...
        var heroShape = new p2.Circle(hero.height * 0.6 / factor); // 根据英雄形状创建碰撞框
    ...
    p.worldLogic = function (dt) {
        ...
        // 浮动台阶左右循环移动
        var floatFloor = this.floatFloor;
        var length = (floatFloor[0].shapes[0]).length / 2;
